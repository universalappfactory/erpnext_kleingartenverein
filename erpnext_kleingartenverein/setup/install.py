...
def add_dashboard_navigation():
    try:
        ...
        entry.icon = "fa-home"
        entry.mode = "Router"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'My Club'), None):
        ...
        entry.icon = "fa-globe"
        entry.mode = "External"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'Homepage'), None):
            club_settings.append("dashboard_menu_entries", entry)
        ...
        entry.mode = "External"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'Desk'), None):
            club_settings.append("dashboard_menu_entries", entry)
        ...
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'Meeting Minutes'), None):
            club_settings.append("dashboard_menu_entries", entry)
        ...
        entry.icon = "fa-list"
        entry.mode = "Router"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'Tenants'), None):
            club_settings.append("dashboard_menu_entries", entry)
        ...
        entry.icon = "fa-user"
        entry.mode = "Router"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'New Letter'), None):
            club_settings.append("dashboard_menu_entries", entry)
        ...
        entry.icon = "fa-flag"
        entry.mode = "Router"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'Reports'), None):
            club_settings.append("dashboard_menu_entries", entry)
        ...
        entry.mode = "External"
        if not next((doc for doc in club_settings.dashboard_menu_entries if doc.description == 'Logout'), None):
            club_settings.append("dashboard_menu_entries", entry)
