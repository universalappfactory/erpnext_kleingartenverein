        ...
        <div ref="dropDown" :class="dropDownVisible ? 'relative' : 'hidden'" style=""
            ...
            <div class="p-3">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="input-group-search" v-model="search.searchOptions.query"
            ...
            <ul class="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200"
                ...
                <li v-for="(item, index) of search.items">
                    <div class="flex items-center pl-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input id="checkbox-item-11" type="checkbox" :value="item.selected" :checked="item.selected"
