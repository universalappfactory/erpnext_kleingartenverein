<template>
    <div class="flex place-items-center">
        ...
        <template v-if="label !== ''">
            <label class="block text-sm mr-2 align-middle font-medium text-gray-900">{{ label
            }}</label>
        </template>
        <select :disabled="disabled" v-model="currentValue"
            class="grow bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
