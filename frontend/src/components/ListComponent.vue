    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <TableHead v-for="(col, index) in headerList" :key="index" :name="col" />
                </tr>
            </thead>
            <tbody>
                <tr @dblclick="openDetails(item)" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
        ...
        <template v-if="hasNext">
            <div class="flex items-center justify-center px-4 py-4" aria-label="Table navigation">
                <button type="button" @click="$emit('loadMore')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
