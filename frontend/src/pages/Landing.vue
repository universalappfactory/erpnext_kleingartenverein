<template>
  <div>
    ...
    <div class="bg-graygreen-300 bg-graygreen-400 bg-sand bg-nature-white">
  ...
  >
   ...
   <Alert title="Info">
    ...
    <template #actions>
      <Button appearance="primary" @click="doIt()">Take Action</Button>
    </template>
  </Alert>

      <div
        class="relative pt-16 pb-32 flex content-center items-center justify-center bg-red-600"
      ...
      >
        ...
        >
          <span
            id="blackOverlay"
            class="w-full h-full absolute opacity-75 bg-red-100"
          ></span>
        </div>
      ...
      <section class="pb-20 bg-nature-dark -mt-24">
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap">
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div
                class="relative flex flex-col min-w-0 break-words bg-nature-light50 w-full mb-8 shadow-lg rounded-lg"
              >
